...
/**
 * api guard,scripts.auth.token.TrySetToken，检查身份验证
 *
 * 尝试设置token,有些场景是不强制要求用户登录，比如购物车，可以登录或是不登录
 ...
 */
export function TrySetToken(
  path: string,
  params: QueryObjectIn,
  queries: QueryObjectIn,
