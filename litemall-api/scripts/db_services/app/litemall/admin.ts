...
export class AppLitemallAdminService {
  ...
  static Upsert(
    ...
    return Process(
      `models.${AppLitemallAdminService.ModelID}.Upsert`,
      data,
      uniqueBy,
      updateColumns
    );
   ...
   * @returns
   */
  static InsertBatch(data: IAppLitemallAdmin[]): number {
   ...
   * @returns
   */
  static Save(data: Partial<IAppLitemallAdmin>): number {
   ...
   * @returns
   */
  static Update(key: number, line: Partial<IAppLitemallAdmin>) {
    return Process(
  ...
  static UpdateWhere(
    query: YaoQueryParam.QueryParam,
    line: Partial<IAppLitemallAdmin>
  ) {
    return Process(
   ...
   * @returns
   */
  static EachSave(data: IAppLitemallAdmin[], line: Partial<IAppLitemallAdmin>) {
    return Process(
  ...
  static DeleteAll() {
    return new Query('default').Run({
      sql: { stmt: `delete from ${AppLitemallAdminService.TableName}` }
    });
  }
